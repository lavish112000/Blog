...
class BlogManager {
  ...
  getSamplePosts() {
    return [
      ...
      },
      {
        ...
        featured: true,
        image:
          "https://images.unsplash.com/photo-1560472355-a9a6e19f4b13?w=800",
        views: 950,
        comments: 19,
      },
      {
  ...
  renderPopularPosts() {
    const popularPostsContainer = document.querySelector(
  ...
  showPostModal(post) {
    ...
    modal.addEventListener("click", (e) => {
      if (
        e.target === modal ||
        e.target.classList.contains("post-modal-close")
      ) {
        modal.remove();
      }
    });
